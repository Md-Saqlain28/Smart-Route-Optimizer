...
export const presets = {
  ...
  regional_12: {
    ...
    nodes: [
      { id: 0, label: "Regional Hub Terminal", x: 300, y: 200, isHub: true, labelOffsetX: -55, labelOffsetY: -20 },
      { id: 1, label: "Airport Cargo Area", x: 160, y: 100 },
      { id: 2, label: "Port Terminal Alpha", x: 480, y: 80, labelOffsetX: -45, labelOffsetY: -20 },
      ...
      { id: 8, label: "State Border Outpost", x: 290, y: 50, labelOffsetX: -55, labelOffsetY: -20 },
      { id: 9, label: "Commercial Hub East", x: 410, y: 150, labelOffsetX: 50, labelOffsetY: 20 },
      { id: 10, label: "Residential Zone B", x: 390, y: 270, labelOffsetX: -50, labelOffsetY: 20 },
      { id: 11, label: "Freight Station West", x: 190, y: 270, labelOffsetX: 50, labelOffsetY: 20 },
    ],
    edges: [
